...
Setup:
 ...
 - [x]  File with job description (or user copy paste description)
...
Prepare job description for loading:
 - [ ]  Remove non alpha
 - [x]  Lowercase all
 - [x]  Load job description into list
 - [x]  Count skills, using skills.csv for the skills to look for
 - [x]  Pass or Fail job description
...
Task list:
 ...
 - [x]  Figure out data structure for job description
 - [x]  CODE read skill ratings into variables from a CSV source
 - [ ]  CODE Read resume into data structure
>Need dates, companies and words list (work history with skills data)
 - [x]  CODE: Read Job Description into data structure
 - [x]  CODE: Rank job vs skills
 - [x]  CODE: If pass: get skills, dates & comps from resume
